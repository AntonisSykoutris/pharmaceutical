...
export const TeamSection = () => {
  const teamList: TeamMemberProps[] = [
    {
      imageUrl: '/team/tmp.png',
      firstName: 'Antonis',
      lastName: 'Ligidakis',
      positions: ['Pharmaceutical Regulations Expert', 'Compliance Advisor'],
      socialNetworks: [
        {
          name: 'LinkedIn',
          url: 'https://www.linkedin.com/in/antonis-ligidakis/', // Update if available
        },
      ],
    },
    {
      ...
      firstName: 'Antonis',
      lastName: 'Sykoutris',
      positions: ['Full Stack Developer', 'Frontend & Backend Engineer'],
      socialNetworks: [
        {
          name: 'LinkedIn',
          url: 'https://www.linkedin.com/in/antonis-sykoutris/', // Update if available
        },
        {
          name: 'Github',
          url: 'https://github.com/antonis-sykoutris', // Update if available
        },
      ],
    },
    {
      ...
      socialNetworks: [
        {
          name: 'LinkedIn',
          url: 'https://www.linkedin.com/in/vasilis-tripodakis/', // Update if available
        },
        {
          name: 'Github',
          url: 'https://github.com/vasilis-tripodakis', // Update if available
        },
      ],
    },
  ];
